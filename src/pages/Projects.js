  ...
  const projects = [
    {
      ...
      description: "Developed an innovative AI-powered WordPress plugin with an intuitive user interface, enhancing website functionality and user experience.",
    ...
    },
    {
      ...
      description: "Responsive personal portfolio website built with React and Tailwind CSS, showcasing professional experience and projects.",
    ...
    },
    {
      ...
      description: "Collection of web development projects demonstrating skills in front-end and back-end technologies.",
