...
function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 text-center px-4 mt-12">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 mb-8">
          <p className="text-gray-600 leading-relaxed">
            Front-end developer with experience building responsive web
            applications using JavaScript, jQuery, HTML, and CSS. Hold a BSc in
            Computer Science, with a strong technical foundation and
            problem-solving skills, committed to delivering clean, efficient,
        ...
        <div className="flex justify-center space-x-4 text-gray-600">
          <div>
            <strong>Phone:</strong>
            <br></br>
            <a href="tel:+972502001376" className="hover:text-blue-500">
              +972-50-200-1376
            </a>
          </div>
          <div>
            ...
            >
              gefenbar23@gmail.com
            </a>
          </div>
          <div>
            <strong>Location:</strong>
            <br></br>Ramat Gan, Israel
          </div>
        </div>
